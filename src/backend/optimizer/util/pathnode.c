 ...
 */
bool
add_path_precheck(RelOptInfo *parent_rel, Cost startup_cost, Cost total_cost,
                  List *pathkeys, Relids required_outer)
{
    if (add_path_precheck_hook)
        return (*add_path_precheck_hook) (parent_rel, startup_cost,
                                          total_cost, pathkeys, required_outer);
    else
        return standard_add_path_precheck(parent_rel, startup_cost,
                                           total_cost, pathkeys, required_outer);
}
 ...
 */
bool
standard_add_path_precheck(RelOptInfo *parent_rel,
                          ...
                          List *pathkeys)
{
    if (add_partial_path_precheck_hook)
        return (*add_partial_path_precheck_hook) (parent_rel, total_cost,
                                                   pathkeys);
    else
        return standard_add_partial_path_precheck(parent_rel, total_cost,
                                                   pathkeys);
}
 ...
 */
bool
standard_add_partial_path_precheck(RelOptInfo *parent_rel, Cost total_cost,
						  List *pathkeys)
{
	ListCell   *p1;
