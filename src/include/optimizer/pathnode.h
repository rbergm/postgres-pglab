...
typedef bool (*add_path_precheck_hook_type) (RelOptInfo *parent_rel,
                                             Cost startup_cost, Cost total_cost,
                                             List *pathkeys, Relids required_outer);
extern add_path_precheck_hook_type add_path_precheck_hook;
typedef bool (*add_partial_path_precheck_hook_type) (RelOptInfo *parent_rel,
...
extern bool add_path_precheck(RelOptInfo *parent_rel,
							  Cost startup_cost, Cost total_cost,
							  List *pathkeys, Relids required_outer);
extern bool standard_add_path_precheck(RelOptInfo *parent_rel,
                                       Cost startup_cost, Cost total_cost,
                                       List *pathkeys, Relids required_outer);
